...
# JULIA_NUM_THREADS=4 julia -O3 -p6 LCM_SLAM_client.jl -i 300000 -s 0.1 --kappa_odo 20.0 --magStdDeg 5.0 --stride_range 3 --odoGyroBias --dbg --savePlotting
#  --dbg --savePlotting --fixedlag 50
#
