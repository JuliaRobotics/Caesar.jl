...
ROS integration is a priority for this project and will accompany the so-called ['prime time'](https://github.com/JuliaRobotics/RoME.jl/issues/147) release of the code.  ROS and [ZMQ multi-language integration](concepts/multilang) are closely related.

> **Note** the present focus (2018Q3-2019Q2) is on first stabilizing the [ZMQ interface](concepts/multilang).
