...
H, pcmovd, stat = Caesar._PCL.alignICP_Simple(X_fix, X_mov)

##

# LieAlgebra expontiation based ref:
H_ref = [
  0.999392    4.89177e-5  -0.0348611   0.0995209
  -0.00126357  0.999393    -0.0348214  -0.0498342
   0.0348382   0.0348443    0.998785   -0.0499514
   0.0         0.0          0.0         1.0
]
# non-rigid (un-normalized R)
# H_ref = [
...
# with rotation Lie Algebra exp map modification
pcmv_ref_10 = [
  0.634187  0.0414235  -0.429596
  0.639184  0.0424166  -0.429387
  0.638185  0.0424179  -0.429422
  0.638185  0.0404191  -0.429491
  0.632188  0.0404267  -0.4297
  0.634187  0.0404241  -0.429631
  0.636186  0.041421   -0.429526
  0.640184  0.0404166  -0.429421
  0.633188  0.0434236  -0.429561
  0.63019   0.042428   -0.4297
]
pcmv_ref_end = [
  -0.440997  0.232817  0.109241
  -0.444994  0.231823  0.109067
  -0.432001  0.249795  0.110147
  -0.433001  0.247798  0.110043
  -0.438997  0.253802  0.110043
  -0.436998  0.256797  0.110217
  -0.434999  0.249799  0.110043
  -0.437997  0.251802  0.110008
  -0.436999  0.237809  0.109555
  -0.446993  0.233824  0.109067
]
...
# ]
# pcmv_ref_end = [
#   -0.441908  0.232918  0.109252
#   -0.445912  0.231923  0.109076
#   -0.432898  0.2499    0.110164
#   -0.433899  0.247902  0.110059
#   -0.439904  0.253907  0.110059
#   -0.437902  0.256904  0.110235
#   -0.435901  0.249904  0.110059
#   -0.438903  0.251907  0.110024
#   -0.437903  0.237911  0.109567
#   -0.447914  0.233925  0.109076
# ]


@test isapprox(H_ref, H; atol = 1e-4)
@test isapprox(pcmv_ref_10, pcmovd[1:10,:]; atol = 1e-4)
@test isapprox(pcmv_ref_end, pcmovd[end-9:end,:]; atol = 1e-4)
