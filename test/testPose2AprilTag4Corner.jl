...
@test 0.4 < ARR[3].Z.Z.μ[1] < 0.5
@test 0.2 < ARR[3].Z.Z.μ[2]
@test abs(ARR[3].Z.Z.μ[3]) < 0.1

# tag on the right should be on the right
@test 0.4 < ARR[38].Z.Z.μ[1] < 0.5
@test ARR[38].Z.Z.μ[2] < -0.2
@test abs(ARR[38].Z.Z.μ[3]) < 0.1

# check a tag in the center should be near the center
@test 0.4 < ARR[18].Z.Z.μ[1] < 0.5
@test abs(ARR[18].Z.Z.μ[2]) < 0.1
@test abs(ARR[18].Z.Z.μ[3]) < 0.1

# check vertical-only displacement
@test 0.4 < ARR[1].Z.Z.μ[1] < 0.5
@test 0.15 < ARR[1].Z.Z.μ[2] < 0.3
@test abs(ARR[1].Z.Z.μ[3]) < 0.1

@test 0.4 < ARR[5].Z.Z.μ[1] < 0.5
@test 0.15 < ARR[5].Z.Z.μ[2] < 0.3
@test abs(ARR[5].Z.Z.μ[3]) < 0.1
