...
@test isapprox( getObservation(fg, :x0x1f1).align.cloud1.data,getObservation(fg_, :x0x1f1).align.cloud1.data )
@test isapprox( getObservation(fg, :x0x1f1).align.cloud2.data,getObservation(fg_, :x0x1f1).align.cloud2.data )

##


@test_broken isapprox(
  getPoints(getObservation(fg, :x0x1f1).align.cloud1.densityFnc)[1],
  getPoints(getObservation(fg_, :x0x1f1).align.cloud1.densityFnc)[1]
)
