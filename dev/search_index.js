...
{
    "location": "installation_environment/#RoMEPlotting.jl-for-2D-plots-1",
    "page": "Installation",
    "title": "RoMEPlotting.jl for 2D plots",
    "category": "section",
    "text": "Previous versions of libraries required the following Linux system packages be installed:sudo apt-get install libfontconfig1\nsudo apt-get install gettext\nsudo apt-get install libcairo2\nsudo apt-get install libpango1.0-0  # or libpango1.0-1The RoMEPlotting.jl package must be installed up to latest master branch (development branch) owing to an upstream issue with Pango fonts on Julia 1.0 with Gadfly.jl plotting.  Once this issue is resolved, the next RoMEPlotting stable version can be tagged and be available as a standard stable release.Please install the latest RoMEPlotting using Package manager as follows:$ julia # latest v1.0.x\njulia> ] # to get package manager\n(v1.0) pkg> add RoMEPlotting#masterAlternatively, the dev command –- i.e. (v1.0) pkg> dev RoMEPlotting –- will clone the RoMEPlotting.jl git repository to your local .julia/dev/RoMEPlotting folder.Last updated February 2019"
},
...
{
    "location": "concepts/concepts/#What-are-Variables-and-Factors-1",
    "page": "Caesar Concepts",
...

{
    ...
    "category": "section",
    "text": "This section discusses the various concepts in the Caesar framework.The initial steps in constructing and solving graphs can be found in Building and Solving Graphs.We also recommend reviewing the various examples available in the Examples section."
},
...

{
    ...
    "page": "ContinuousScalar as 1D Example",
    "title": "ContinuousScalar as 1D Example",
    "category": "page",
    "text": ""
},
...

{
    ...
    "category": "section",
    "text": "At this point we can call the solver start interpreting the first results:tree = batchSolve!(fg)The factor graph figure above showed the structure between variables and factors. In order to see the numerical values contained in the factor graph, a set of tools are provided by the RoMEPlotting and KernelDensityEstimatePlotting packages. For more details, please see the dedicated visualization discussion here.First look at the two landmark positions :l1, :l2 at (10.0,30),(30.0,-30) respectively.using RoMEPlotting\n\nplotKDE(fg, [:l1;:l2], dims=[1;2])(Image: testl1_2)Similarly, the belief estimate for the first vehicle position :l100 is bi-modal, due to the intersection of two range measurements:plotKDE(fg, :l100, dims=[1;2], levels=6)(Image: testl100)An alternative plotting interface can also be used, that shows a histogram of desired elements instead:drawLandms(fg, from=1, to=101)(Image: testlall)Notice the ring of particles which represents the belief on the third beacon/landmark :l3, which was not constrained by a prior factor. Instead, the belief over the position of :l3 is being estimated simultaneous to estimating the vehicle position :l100."
},

{
    "location": "examples/basic_slamedonut/#Implicit-Growth-and-Decay-of-Modes-(i.e.-Hypotheses)-1",
    "page": "Under-defined Trilateration SLAM 2D",
...
{
    "location": "refs/literature/#Direct-References-1",
    "page": "References",
    "title": "Direct References",
    "category": "section",
    "text": "[1.1]  Fourie, D., Leonard, J., Kaess, M.: \"A Nonparametric Belief Solution to the Bayes Tree\" IEEE/RSJ Intl. Conf. on Intelligent Robots and Systems (IROS), (2016).[1.2]  Fourie, D.: \"Multi-modal and Inertial Sensor Solutions for Navigation-type Factor   Graphs\", Ph.D. Thesis, Massachusetts Institute of Technology Electrical Engineering and Computer Science together with Woods Hole Oceanographic Institution Department for Applied Ocean Science and Engineering, September 2017.[1.3]  Fourie, D., Claassens, S., Pillai, S., Mata, R., Leonard, J.: \"SLAMinDB: Centralized graph databases for mobile robotics\", IEEE Intl. Conf. on Robotics and Automation (ICRA), Singapore, 2017.[1.4]  Cheung, M., Fourie, D., Rypkema, N., Vaz Teixeira, P., Schmidt, H., and Leonard, J.: \"Non-Gaussian SLAM utilizing Synthetic Aperture Sonar\", Intl. Conf. On Robotics and Automation (ICRA), IEEE, Montreal, 2019.[1.5]  Doherty, K., Fourie, D., Leonard, J.: \"Multimodal Semantic SLAM with Probabilistic Data Association\", Intl. Conf. On Robotics and Automation (ICRA), IEEE, Montreal, 2019.[1.6]  Fourie, D., Vaz Teixeira, P., Leonard, J.: \"Non-parametric Mixed-Manifold Products using Multiscale Kernel Densities\", IEEE Intl. Conf. on Intelligent Robots and Systems (IROS), (2019), under-review.[1.7]  Fourie, D., Leonard, J.: \"Inertial Odometry with Retroactive Sensor Calibration\", publication under review."
},

{
    "location": "refs/literature/#Important-References-1",
    "page": "References",
    "title": "Important References",
    "category": "section",
    "text": "[2.1]  Kaess, Michael, et al. \"iSAM2: Incremental smoothing and mapping using the Bayes tree\" The International Journal of Robotics Research (2011): 0278364911430419.[2.2]  Kaess, Michael, et al. \"The Bayes tree: An algorithmic foundation for probabilistic robot mapping.\" Algorithmic Foundations of Robotics IX. Springer, Berlin, Heidelberg, 2010. 157-173.[2.3]  Kschischang, Frank R., Brendan J. Frey, and Hans-Andrea Loeliger. \"Factor graphs and the sum-product algorithm.\" IEEE Transactions on information theory 47.2 (2001): 498-519.[2.4]  Dellaert, Frank, and Michael Kaess. \"Factor graphs for robot perception.\" Foundations and Trends® in Robotics 6.1-2 (2017): 1-139.[2.5]  Sudderth, E.B., Ihler, A.T., Isard, M., Freeman, W.T. and Willsky, A.S., 2010. \"Nonparametric belief propagation.\" Communications of the ACM, 53(10), pp.95-103[2.6]  Farrell, J., and Matthew B.: \"The global positioning system and inertial navigation.\" Vol. 61. New York: Mcgraw-hill, 1999.[2.7]  Zarchan, Paul, and Howard Musoff, eds. Fundamentals of Kalman filtering: a practical approach. American Institute of Aeronautics and Astronautics, Inc., 2013.[2.8]  Hanebeck, Uwe D. \"FLUX: Progressive State Estimation Based on Zakai-type Distributed Ordinary Differential Equations.\" arXiv preprint arXiv:1808.02825 (2018).[2.9]  Muandet, Krikamol, et al. \"Kernel mean embedding of distributions: A review and beyond.\" Foundations and Trends® in Machine Learning 10.1-2 (2017): 1-141."
},

{
    "location": "refs/literature/#Additional-References-1",
    "page": "References",
    "title": "Additional References",
    "category": "section",
    "text": "[3.1]  Duits, Remco, Erik J. Bekkers, and Alexey Mashtakov. \"Fourier Transform on the Homogeneous Space of 3D Positions and Orientations for Exact Solutions to Linear Parabolic and (Hypo-) Elliptic PDEs.\" arXiv preprint arXiv:1811.00363 (2018)."
},
